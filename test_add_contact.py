...
class TestAddGroup(unittest.TestCase):
    ...
    def test_contact(self):
        ...
        self.create_contact(wd, first_name="Test", last_name="Testoff", address="Samara",
    ...
    def create_contact(self, wd, first_name, last_name, address, home_phone, mobile_phone, work_phone, fax_phone,
                       email_add, email2_add, email3_add):
        # fill contact form
        ...
        wd.find_element_by_name("email").send_keys(email_add)
        wd.find_element_by_name("email2").click()
        wd.find_element_by_name("email2").clear()
        wd.find_element_by_name("email2").send_keys(email2_add)
        wd.find_element_by_name("email3").click()
        wd.find_element_by_name("email3").clear()
        wd.find_element_by_name("email3").send_keys(email3_add)
